					...
					<div className="col-md-8 m-auto">
						<Link to="/dashboard" className="btn btn-light">
						 ...
						 <form onSubmit={this.onSubmit}>
						 	...
						 	<h6> To Date</h6>
						 	<TextFieldGroup type="date" name="to" value={this.state.to} onChange={this.onChange} error={errors.to} disabled={this.state.disabled}	/>
						 	...
						 	<TextAreaFieldGroup placeholder = "Job description" name="description" value={this.state.description} onChange={this.onChange} error={errors.description}
